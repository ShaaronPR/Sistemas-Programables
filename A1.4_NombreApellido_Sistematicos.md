...
RRealize a temperature measuring sensor through an electronic circuit, using a simulator, and a temperature linear **Transistor TMP36** and an **operational amplifier LM741**.
