...
<p align="left"> 
        <img alt="Evidencia 1" src="https://github.com/ShaaronPR/Sistemas-Programables/blob/main/imagenes/Evidencia1.PNG" >
    </p>
    
   <p align="left"> 
        <img alt="Evidencia 2" src="https://github.com/ShaaronPR/Sistemas-Programables/blob/main/imagenes/Evidencia2.PNG">
    </p>
   <p align="left"> 
        <img alt="Evidencia 3" src="https://github.com/ShaaronPR/Sistemas-Programables/blob/main/imagenes/Evidencia3.PNG" >
    </p>
    
   <p align="left"> 
        <img alt="Evidencia 4" src="https://github.com/ShaaronPR/Sistemas-Programables/blob/main/imagenes/Evidencia4.PNG" >
    </p>
    
   <p align="left"> 
        <img alt="Evidencia 5" src="https://github.com/ShaaronPR/Sistemas-Programables/blob/main/imagenes/Evidencia5.PNG" >
    </p>
    
   <p align="left"> 
        <img alt="Evidencia 6" src="https://github.com/ShaaronPR/Sistemas-Programables/blob/main/imagenes/Evidencia6.PNG">
    </p>
    
 <p align="left"> 
        <img alt="Evidencia 7" src="https://github.com/ShaaronPR/Sistemas-Programables/blob/main/imagenes/Evidencia7.PNG" >
    </p>
    
   <p align="left"> 
        <img alt="Evidencia 8" src="https://github.com/ShaaronPR/Sistemas-Programables/blob/main/imagenes/Evidencia8.PNG" >
    </p>
   <p align="left"> 
        <img alt="Evidencia 9" src="https://github.com/ShaaronPR/Sistemas-Programables/blob/main/imagenes/Evidencia9.PNG" >
    </p>
...
:file_folder: [Link to activity](https://github.com/ShaaronPR/Sistemas-Programables/blob/main/A1.2_NombreApellido_Sistematicos.md)
