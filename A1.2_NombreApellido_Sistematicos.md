...
## A.1.2 Realize a light measuring sensor (lux) through an electronic circuit, using a simulator, and a LDR (Light dependent Resistor).
...
4. Place the finally obtained image of the assembled circuit inside your simulator.
   ...
   <p align="center"> 
        <img alt="CircuitoLDR" src="../img/C1.X_TinkerCad_Circuito_LDR.png" width=600 height=450>
    </p>
