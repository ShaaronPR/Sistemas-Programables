...
I think this practice is one of the most interesting so far, I like how this one pushes us to find ways of controlling circuits from a device via bluetooth since it is something that feels closer to the uses we could make of electronics in our daily lives. There's a few applications available for bluetooth control with their respective libraries so I found the programming side interesting.  At simple look it doesn't look overly complicated but it is a bit difficult to really grasp the whole workings of the physical circuit from theory and videos I imagine working directly with the whole thing would make my understanding of all clearer so once again I felt the current situation dissatisfying. 
