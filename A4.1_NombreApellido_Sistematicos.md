...
```
    ...
    1. [ESP32 Arduino: Serial communication over Bluetooth Hello World](https://techtutorialsx.com/2018/03/09/esp32-arduino-serial-communication-over-bluetoth-hello-world/)
    2. [constantes](https://www.arduino.cc/reference/es/language/variables/constants/constants/)
    3. [ESP32: Empezando a usar el Bluetooth (SPP)](https://www.electrosoftcloud.com/esp32-empezando-a-usar-el-bluetooth-spp/)
