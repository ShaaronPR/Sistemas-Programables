...
1. Use the following list of commercial sensor models to elaborate your activity:
   ...
   - [ ] 1.7 Sensor Infrared Remote Control [AX-1838HS](https://articulo.mercadolibre.com.mx/MLM-665821120-modulo-sensor-reconocimiento-de-color-rgb-tcs34725arduino-_JM?quantity=1#position=1&type=item&tracking_id=fd55dc31-3426-49ad-999f-ef5cf0a70bf0)
...
3. Once you know the topic to develop, research and write within this document the following points:
   ...
   - **Cover**, información del alumno, asesor, carrera, materia, fecha,..
   - **Introduction**, una breve descripción de que tratara el tema.
   - **Development**
     - **Definition**.
     - Sensor **images**.
